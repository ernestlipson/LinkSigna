...
class InterpreterZoomScreen extends StatefulWidget {
  const InterpreterZoomScreen({super.key});

  @override
  State<InterpreterZoomScreen> createState() => _InterpreterZoomScreenState();
}

class _InterpreterZoomScreenState extends State<InterpreterZoomScreen> {
  ...
  void initState() {
    ...
    _displayNameController.text =
        'Interpreter_${DateTime.now().millisecondsSinceEpoch % 1000}';
  }
